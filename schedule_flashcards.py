...
# 1. hyperparameter tuning: https://www.analyticsvidhya.com/blog/2021/05/tuning-the-hyperparameters-and-layers-of-neural-network-deep-learning/
# 2. data problems -- simplify to see if we can find a relationship between just interval and success (it's visible from a graph, should be linear)
# 3. data problems -- sample specifically those reviews that deviate most from expected interval
# predict something else? interval with 90% success? use a bayesian

# research "half-life regression" and Mozer/Duolingo/ebisu: https://fasiha.github.io/ebisu/
...
# Evaluate the model
loss, accuracy, precision = neural_model.evaluate(X_test, y_test)
print('Neural Network Accuracy: %.2f' % (accuracy*100))
print('Neural Network Precision: %.2f' % (precision*100))
